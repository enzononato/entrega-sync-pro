  ...
  return (
    <div className="space-y-4 animate-fade-up">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 shadow-sm flex flex-col items-center text-center">
        ...
        {user.worker_type && (
          <span className={cn('inline-flex rounded-lg px-3 py-1 text-xs font-semibold mt-2',
            user.worker_type === 'motorista' ? 'bg-blue-50 text-blue: 'bg-purple-50 text-purple-700'
          )}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <StatCard icon={<CheckCircle className="h-4 w-4 text-emeralblue/>} value={diasNaMeta} label="Dias na meta (30d)" />
      </div>
