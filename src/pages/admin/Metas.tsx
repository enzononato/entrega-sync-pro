  ...
  return (
    <div className="space-y-6 animate-fade-up">
      ...
      {isLoading ? (
        ...
        <MetasListPaginated filteredMetas={filteredMetas} openEdit={openEdit} setToggleTarget={setToggleTarget} setConfirmOpen={setConfirmOpen} getInitials={getInitials} getScope={getScope} />
      )}
